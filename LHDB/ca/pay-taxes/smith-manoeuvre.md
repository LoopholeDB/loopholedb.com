...
category: "pay-taxes"
country: "ca"
summary: "Convert your non-deductible Canadian mortgage into tax-deductible investment debt by borrowing against home equity to invest, generating annual tax refunds that further pay down your mortgage."
tags: ["mortgage", "tax deduction", "investing", "HELOC", "CRA"]
difficulty: "medium"
lastUpdated: "2025-01-01"
ai_prompt: "I am a Canadian homeowner interested in implementing the Smith Manoeuvre to convert my non-deductible mortgage into tax-deductible investment debt. My current mortgage balance is approximately $[AMOUNT] with [X] years remaining, my home's current value is $[AMOUNT], and my marginal tax rate is approximately [X]%. I [do / do not] currently have a re-advanceable mortgage with a HELOC component. Help me determine if I qualify, calculate the approximate annual tax refund I could generate, explain the investment account setup required, and outline the risks I need to manage."
---
...
2. Immediately re-borrow the principal portion from your HELOC
3. Invest those funds in dividend-paying stocks, ETFs, or other income-producing assets
4. Claim the HELOC interest as a tax deduction on your income tax return
5. Use the tax refund to make a lump-sum payment against your mortgage principal

Over time, your mortgage shrinks while your HELOC (tax-deductible) and investment portfolio grow.

## Step-by-Step Setup

1. **Qualify for a re-advanceable mortgage** — offered by most major Canadian banks (e.g., TD FlexLine, RBC Homeline, BMO Readiline). You typically need 20%+ equity.
2. **Open a non-registered investment account** specifically for Smith Manoeuvre investing (a TFSA or RRSP will not preserve the interest deductibility).
3. **Draw from the HELOC** immediately after each mortgage payment and transfer funds to the investment account.
4. **Keep meticulous records** — maintain a separate HELOC sub-account exclusively for investment borrowing. Commingling funds (e.g., using the HELOC for a car) breaks the deductibility trail.
5. **File annually** — deduct HELOC interest on Line 22100 (carrying charges and interest expense) of your T1 return.

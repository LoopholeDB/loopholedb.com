---
title: "RESP-to-RRSP Conversion (Accumulated Income Payment)"
slug: "resp-rrsp-conversion"
category: "saving-for-retirement"
country: "ca"
summary: "If a child doesn't pursue post-secondary education, RESP subscribers can roll up to $50,000 of accumulated income directly into their RRSP — tax-deferred — avoiding a hefty penalty tax, provided they have available RRSP room."
tags: ["RESP", "RRSP", "education savings", "AIP", "CESG", "CRA"]
difficulty: "medium"
lastUpdated: "2025-01-01"
ai_prompt: "I have an RESP for my child who is now [AGE] years old and [will not be / is unlikely to] pursue post-secondary education. The RESP was opened in [YEAR] and the current balance is approximately $[AMOUNT], of which approximately $[AMOUNT] is my original contributions and $[AMOUNT] is investment growth and government grants. I have approximately $[AMOUNT] in available RRSP contribution room. Help me determine if I qualify for the AIP-to-RRSP rollover, calculate how much I can transfer tax-free versus how much I'll pay penalty tax on, and advise on whether I should consider keeping the RESP open or changing beneficiaries."
---
...
1. **Confirm eligibility** — Ensure the plan has been open 10+ years and the beneficiary is 21+. Contact your RESP provider to confirm AIP eligibility.
2. **Check your RRSP room** — View your available contribution room on your CRA My Account or on last year's Notice of Assessment. The rollover uses your RRSP room.
3. **Repay grants first** — The CESG (and BCTESG, QESI, A-CESG if applicable) must be **returned to the government** before you can access the accumulated income. This is automatic — your financial institution handles it.
4. **Withdraw contributions tax-free** — Your original contributions (not earnings) can always be withdrawn by the subscriber, tax-free and penalty-free, at any time.
5. **Request the AIP-to-RRSP transfer** — Ask your RESP provider to transfer accumulated income directly to your RRSP (up to $50,000). This is reported on a T4A but offset by the RRSP deduction.
6. **Any excess AIP** — If accumulated income exceeds $50,000, the excess is subject to full income tax + 20% penalty. Consider timing withdrawals across multiple years or splitting with the beneficiary as EAPs if they later enroll.

---
title: "Access to Information Requests (ATIA)"
slug: "access-to-information-requests"
category: "dealing-with-government"
country: "ca"
summary: "Canada's Access to Information Act gives every person — citizen or not — the right to request federal government records. Used effectively, ATI requests uncover government communications, contracts, internal policies, and spending data that bureaucracies prefer to keep quiet."
tags: ["access to information", "ATIA", "ATI", "FOIA equivalent", "government transparency", "OIC"]
difficulty: "easy"
lastUpdated: "2025-01-01"
ai_prompt: "I want to file an Access to Information request with the federal government of Canada. I'm looking for [DESCRIBE RECORDS: e.g., briefing notes about a policy / contracts with a specific company / my own immigration file / inspection records]. The institution I believe holds these records is [DEPARTMENT/AGENCY NAME]. Help me identify exactly which institution and ATIP office to file with, draft a specific and effective ATI request, advise on whether I qualify for a fee waiver, and explain what to do if the institution claims the records are exempt or if they exceed the 30-day deadline."
...
### Online (Preferred)
1. Go to **atip.tbs-sct.gc.ca** — the Government of Canada's centralized ATI portal.
2. Create a free account.
3. Identify the correct institution that would hold the records.
4. Describe the records as specifically as possible: date ranges, subject matter, names of officials, types of documents (emails, briefing notes, contracts, etc.).
5. Pay the **$5 application fee** (credit/debit). Note: if the records relate to your own personal information, there is **no fee**.
6. Submit.

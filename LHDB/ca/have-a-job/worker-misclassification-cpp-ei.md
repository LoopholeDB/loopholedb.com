---
title: "Worker Misclassification: Reclaiming CPP & EI as a Contractor"
slug: "worker-misclassification-cpp-ei"
category: "have-a-job"
country: "ca"
summary: "If CRA determines you were misclassified as an independent contractor when you were actually an employee, you can recover the employer's share of CPP contributions and EI premiums — and gain access to EI benefits, vacation pay, and employment standards protections."
tags: ["worker misclassification", "CPP", "EI", "CRA", "employment standards", "contractor"]
difficulty: "medium"
lastUpdated: "2025-01-01"
ai_prompt: "I am a Canadian worker who has been classified as an independent contractor but I believe I should be an employee. I work for [COMPANY NAME] in [PROVINCE], my role involves [DESCRIBE DUTIES], I earn $[AMOUNT] per year, and I [do / do not] work for other clients. My employer [does / does not] set my hours and methods, and [provides / does not provide] my tools and equipment. Help me assess whether CRA's four-factor test would classify me as an employee, explain what CPP and EI contributions I could recover, and walk me through whether to file a CRA ruling (Form CPT1) or a provincial employment standards complaint."
---
...
|---|---|---|
| **Control** | Boss sets hours, location, methods | Worker decides how/when/where |
| **Ownership of tools** | Company provides equipment | Worker provides own tools |
| **Chance of profit / risk of loss** | Set wage, no financial risk | Can profit more or lose money |
| **Integration** | Work is core to the business | Operates independently, can work for others |
...
**Option 2 — Provincial Employment Standards Complaint**
Each province has an employment standards branch:
...
**Option 3 — Civil Claim**
For larger unpaid amounts, a wrongful dismissal or common law claim in Small Claims Court or Superior Court.

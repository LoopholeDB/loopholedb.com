---
title: "Principal Residence Exemption (PRE)"
slug: "principal-residence-exemption"
category: "own-a-home"
country: "ca"
summary: "Capital gains on the sale of a Canadian principal residence are fully tax-exempt — with no dollar cap. Strategic use of the PRE can shelter hundreds of thousands of dollars in gains, and eligible Canadians with multiple properties can carefully designate which property qualifies each year."
tags: ["principal residence", "capital gains", "PRE", "real estate", "CRA", "T2091"]
difficulty: "medium"
lastUpdated: "2025-01-01"
ai_prompt: "I am selling a property in Canada and want to understand how the Principal Residence Exemption applies to my situation. I owned the property from [YEAR] to [YEAR] and it is located at [CITY, PROVINCE]. During that time I [lived there the entire time / lived there for [X] years and rented it out for [Y] years / used it as a secondary/cottage property]. I [do / do not] also own another property. Help me calculate the exempt fraction of my capital gain, determine the optimal designation strategy if I have multiple properties, explain how to report the sale on Schedule 3 and Form T2091, and flag any risks with the new property flipping rule."
---
...
1. It is a **housing unit** (house, condo, cottage, mobile home, houseboat, co-op apartment)
2. You, your spouse/common-law partner, or your children **ordinarily inhabited it** at some point during the year
3. You **designate it** as your principal residence for that year (on Form T2091 when you sell)
...
1. Calculate the accrued gain on each property per year of ownership.
2. Allocate the years with the **highest annual gains** to the property with the largest overall gain.
3. The property you sell first can be fully designated; the +1 rule often covers the transition year for the remaining property.

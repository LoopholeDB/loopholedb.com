---
title: "Diminished Value Claims After a Not-At-Fault Accident"
slug: "diminished-value-claim"
category: "insurance"
country: "ca"
summary: "After a not-at-fault accident, your vehicle loses resale value even after repairs. In most Canadian provinces you can claim this 'diminished value' from the at-fault driver's insurer — a right most insurers won't volunteer to tell you about."
tags: ["diminished value", "auto insurance", "not-at-fault", "DCPD", "tort claim", "car accident"]
difficulty: "medium"
...
1. **Document pre-accident value** — Get a written appraisal or use pricing guides (Canadian Black Book, Red Book) to establish your vehicle's pre-accident market value.
2. **Obtain a professional DV appraisal** — Hire an independent auto appraiser (not the insurer's appraiser) to assess the diminished value. Appraiser costs ($200–$500) can often be recovered as part of the claim.
3. **Request the at-fault insurer's position in writing** — Write to the at-fault driver's insurer (or your own under DCPD) claiming DV as part of your property damage settlement. They are legally obligated to consider it.
4. **Negotiate** — Adjusters will often lowball or deny DV initially. Counter with your independent appraisal and comparable sales data.
5. **Small Claims Court** — If the insurer refuses or the offer is inadequate, file in Small Claims Court (provincial limits: $35K in Ontario, $5K in BC CRT, $50K in Alberta, $15K in Quebec).

---
title: "Credit Card Chargeback Rights Under the Fair Credit Billing Act"
category: "Consumer Rights"
country: "US"
difficulty: "Easy"
potential_savings: "Varies — recover full purchase price"
last_verified: "2026-02-10"
applicable_states: "All"
risk_level: "Low"
ai_prompt: "I need to dispute a credit card charge using my rights under the Fair Credit Billing Act. The charge is from [MERCHANT NAME] for $[AMOUNT] on [DATE], and the reason I'm disputing it is [REASON: item not received / not as described / unauthorized / other]. I contacted the merchant on [DATE] and they [refused / didn't respond / said X]. Help me write a dispute letter to my card issuer, identify the strongest legal grounds under the FCBA, and advise on the timeline and what to do if the issuer denies my claim."
...
- [FTC — Disputing Credit Card Charges](https://consumer.ftc.gov/articles/disputing-credit-card-charges)
- [CFPB — What is a billing error?](https://www.consumerfinance.gov/ask-cfpb/what-is-a-billing-error-en-44/)
- [15 U.S. Code § 1666 — Correction of billing errors (Cornell Law)](https://www.law.cornell.edu/uscode/text/15/1666)

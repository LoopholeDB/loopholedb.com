---
title: "Airline Involuntary Bumping Compensation"
category: "Travel"
country: "US"
difficulty: "Easy"
potential_savings: "$400 - $1,550 per incident"
last_verified: "2026-02-10"
applicable_states: "All (federal regulation)"
risk_level: "None"
ai_prompt: "I was involuntarily denied boarding (bumped) on a flight operated by [AIRLINE] on [DATE]. My original flight was [FLIGHT NUMBER] from [ORIGIN] to [DESTINATION], departing at [TIME]. The airline rebooked me on a flight that arrives [X HOURS] later than my original arrival time. They offered me [VOUCHER / MILES / CASH AMOUNT]. Help me calculate the exact cash compensation I'm entitled to under DOT rules, draft a demand letter insisting on cash payment instead of vouchers, and advise on escalating to the DOT if the airline refuses."
...
1. **Arrival delayed 0-1 hour:** No compensation required.
2. **Arrival delayed 1-2 hours (domestic) or 1-4 hours (international):** 200% of your one-way fare, up to $775.
3. **Arrival delayed more than 2 hours (domestic) or more than 4 hours (international):** 400% of your one-way fare, up to $1,550.
4. **If the airline fails to rebook you at all:** 400% of your one-way fare, up to $1,550.

The key steps:

1. **Do not volunteer.** When the airline asks for volunteers to give up their seats, don't raise your hand if you want the higher mandatory compensation. Wait until they involuntarily bump you.
2. **Demand cash compensation.** The airline is required to pay you in cash or check on the spot — the same day, at the airport. They can offer a voucher instead, but you are legally entitled to refuse the voucher and demand payment.
3. **Keep your boarding pass and documentation.** Hold on to your original boarding pass, any written notices from the airline, and notes about the timeline.
4. **You keep your original ticket too.** The compensation is in addition to getting rebooked on another flight. You don't forfeit your right to reach your destination.
...
- [DOT — Bumped from a Flight: Your Rights](https://www.transportation.gov/individuals/aviation-consumer-protection/bumped-flight)
- [14 CFR Part 250 (eCFR)](https://www.ecfr.gov/current/title-14/chapter-II/subchapter-D/part-250)
